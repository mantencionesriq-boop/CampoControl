...
function seedDefaultConfiguration_(sheet) {
  ...
  var defaults = [
    ...
    ['CFG-ESP-LIMON', 'CULTIVO', 'Limonero', true], ['CFG-ESP-NARANJO', 'CULTIVO', 'Naranjo', true],
    ['CFG-ESP-MANDARINO', 'CULTIVO', 'Mandarino', true], ['CFG-ESP-PALTO', 'CULTIVO', 'Palto', true],
    ['CFG-ESP-OLIVO', 'CULTIVO', 'Olivo', true], ['CFG-ESP-MANZANO', 'CULTIVO', 'Manzano', true],
    ['CFG-ESP-PERAL', 'CULTIVO', 'Peral', true], ['CFG-ESP-DURAZNO', 'CULTIVO', 'Duraznero', true],
    ['CFG-ESP-CIRUELO', 'CULTIVO', 'Ciruelo', true], ['CFG-ESP-ALMENDRO', 'CULTIVO', 'Almendro', true],
    ['CFG-ESP-HIGUERA', 'CULTIVO', 'Higuera', true], ['CFG-ESP-GRANADO', 'CULTIVO', 'Granado', true],
    ['CFG-ESP-VID', 'CULTIVO', 'Vid', true], ['CFG-ESP-OTROFRUTAL', 'CULTIVO', 'Otro frutal', true],
