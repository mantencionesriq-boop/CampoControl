function addBitacoraCultural(laborData) {
  try {
    ...
    return withDocumentLock_(function() {
      ...
      // Una labor queda pendiente hasta que el usuario la complete manualmente desde el calendario.
      // La fecha no basta para confirmar que la labor se ejecutó en terreno.
      ...
      appendObjectRow_(getSpreadsheet().getSheetByName('BITACORA_CULTURAL'), {
        ...
        Estado: estado, Fecha_Realizacion: ''
      });
